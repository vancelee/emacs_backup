...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-constant-face ((,class (:foreground "#e6a00f"))))
   `(font-lock-function-name-face ((,class (:foreground "#edd400"))))
   `(font-lock-keyword-face ((,class (:foreground "#729fcf"))))
   `(font-lock-string-face ((,class (:foreground "#ad7fa8"))))
   `(font-lock-type-face ((,class (:foreground "#8ae234"))))
   ...
   `(org-level-2 ((t (:foreground "#edd400" :weight bold))))
   `(org-level-3 ((t (:foreground "#6ac214"))))
   `(org-level-4 ((t (:foreground ,butter-1))))
   ;; Semantic faces
